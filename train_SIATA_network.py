...
for station in range(len(stations_SIATA)):
    ...
    if station in [2,3,4,5,11]:
        ...
        with open("./history_files/h_Station"+stations_SIATA[station], mode='w') as f:
            hist_df.to_json(f)
        mls.model.save("./models/Station"+stations_SIATA[station]+".h5")
